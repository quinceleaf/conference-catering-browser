    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True, help_text='Date Created', verbose_name='Created')),
                ('date_submitted', models.DateTimeField(blank=True, help_text='Date Submitted', null=True, verbose_name='Submitted')),
                ('date_approved', models.DateTimeField(blank=True, help_text='Date Approved', null=True, verbose_name='Approved')),
                ('date_last_updated', models.DateTimeField(auto_now=True, help_text='Date Last Updated', verbose_name='Updated')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_breakdown', models.DateTimeField(blank=True, default=datetime.datetime(2010, 1, 1, 0, 0, tzinfo=utc), help_text='Breakdown', null=True)),
